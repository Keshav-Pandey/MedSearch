...
namespace BingSynonyms {
    ...
    public partial class BingSynonymsContainer : System.Data.Services.Client.DataServiceContext {
        ...
        BingSynonymsContainer context;
        public BingSynonymsContainer(Uri serviceRoot) : 
                base(serviceRoot) {
           
            context = new BingSynonymsContainer(serviceRoot);
            context.Credentials = new NetworkCredential("keshav25@outlook.com", "QjWeA6ecBTi9eDH4+O0GRSWhAsFqmo6E/cF+JErDnZg");
        }
        ...
        public String find1(String para)
        {
            DataServiceQuery<GetSynonymsEntitySet> query = context.GetSynonyms(para);
            String answer = "";
            try
            {
                answer = query.Execute().ToString();
